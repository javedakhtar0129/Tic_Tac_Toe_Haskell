...
/* package TicTacToe-Haskell-0.1.0.0 */
#ifndef VERSION_TicTacToe_Haskell
#define VERSION_TicTacToe_Haskell "0.1.0.0"
#endif /* VERSION_TicTacToe_Haskell */
#ifndef MIN_VERSION_TicTacToe_Haskell
#define MIN_VERSION_TicTacToe_Haskell(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_TicTacToe_Haskell */
...
#define CURRENT_COMPONENT_ID "TicTacToe-Haskell-0.1.0.0-inplace-TicTacToe-Haskell"
